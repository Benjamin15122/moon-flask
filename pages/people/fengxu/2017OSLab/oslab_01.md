...
你首先需要像[实验准备讲义](oslab_preparation)里那样，将 boot loader 程序制作成 512 字节的合法的引导扇区，然后在 boot loader 中完成系统的部分初始化工作，并将游戏程序装载到内存，最后，你要在游戏中完成另外一些初始化工作，实现相关代码，使得游戏能够输出字符串。
...
如果你想玩得更嗨，使用自己的图片和自己的调色板，请自行google相关内容。
